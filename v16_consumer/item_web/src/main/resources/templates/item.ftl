    ...
    <script>
        $(function () {
            ...
            $("#search").click(function () {
                ...
                location.href = "http://localhost:9992/search/query/1/5?keywords="+keywords;
            })
        })
    </script>
</head>
...
<div class="hd-info1 w1200">
    ...
    <div class="search f-r">
        ...
        <div class="srh">
            <div class="ipt f-l">
                <input type="text" placeholder="搜索商品..." ss-search-show="sp" id="keywords"/>
